...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{assets/use-case-1/ipfs-behavior.drawio.png} % Change this to your image file
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{assets/use-case-1/explain-kademlia.png} % Change this to your image file
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{assets/use-case-1/DHT.png} % Change this to your image file
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{assets/use-case-1/XOR1.png} % Change this to your image file
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{assets/use-case-1/XOR2.png} % Change this to your image file
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{assets/use-case-1/exampleNet+.png} % Change this to your image file
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{assets/use-case-1/blobs.png} % Change this to your image file
    \caption{IPFS: blobs}
    \label{fig:sample-image} 
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{assets/use-case-1/List.png} % Change this to your image file
    \caption{IPFS: lists}
    \label{fig:sample-image} 
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{assets/use-case-1/Trees.png} % Change this to your image file
    \caption{IPFS: tree}
    \label{fig:sample-image} 
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{assets/use-case-1/commit.png} % Change this to your image file
    \caption{IPFS: commit}
    \label{fig:sample-image} 
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{assets/use-case-1/ipfshow.png} % Change this to your image file
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{assets/use-case-1/Layer.png} % Change this to your image file
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{assets/use-case-1/Master.png} % Change this to your image file
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{assets/use-case-1/Slave.png} % Change this to your image file
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{assets/use-case-1/global-vision.drawio.png} % Change this to your image file
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{assets/use-case-1/hyper-ledger-view.drawio.png} % Change this to your image file
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{assets/use-case-1/workflow.png} % Change this to your image file
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{assets/use-case-1/swot.png} % Change this to your image file
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{assets/use-case-2/notes-cas.png} % Change this to your image file
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{assets/use-case-2/notes-orderer.png} % Change this to your image file
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{assets/use-case-2/notes-couch.png} % Change this to your image file
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{assets/use-case-2/notes-peers.png} % Change this to your image file
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{assets/use-case-2/notes-channel.png} % Change this to your image file
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{assets/use-case-2/notes-channel-and-chaincode.png} % Change this to your image file
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{assets/use-case-2/default-first-netwrk.drawio.png} % Change this to your image file
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{assets/use-case-2/default-first-hospital.drawio.png} % Change this to your image file
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{assets/use-case-2/robust-network-creation.png} % Change this to your image file
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{assets/use-case-2/first-benchmarking.png} % Change this to your image file
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{assets/use-case-2/first-benchmarking2.png} % Change this to your image file
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{assets/use-case-2/first-benchmarking-hospital.png} % Change this to your image file
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{assets/use-case-2/first-benchmarking-hospital2.png} % Change this to your image file
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{assets/use-case-2/first-benchmarking-hospital3.png} % Change this to your image file
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{assets/use-case-2/kubernetes-study.png} % Change this to your image file
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{assets/use-case-2/kubernetes-study2.png} % Change this to your image file
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{assets/use-case-2/hlf-kuber-premise-network.png} % Change this to your image file
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{assets/use-case-2/hlf-kuber-premise-network2.png} % Change this to your image file
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{assets/use-case-2/automation-diagram.drawio.png} % Change this to your image file
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{assets/use-case-2/automation-creation.png} % Change this to your image file
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{assets/use-case-2/orderer-admin-manager.png} % Change this to your image file
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{assets/use-case-2/peer-manager-prototype-page.png} % Change this to your image file
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{assets/use-case-2/kubernetes-network.drawio.png} % Change this to your image file
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{assets/use-case-2/scenario1.png} % Change this to your image file
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{assets/use-case-2/scenario2.png} % Change this to your image file
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{assets/use-case-2/scenario3.png} % Change this to your image file
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{assets/use-case-2/scenario4.png} % Change this to your image file
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{assets/use-case-2/scenario5.png} % Change this to your image file
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.9\textwidth]{assets/use-case-2/docker.png} % Change this to your image file
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.9\textwidth]{assets/use-case-2/k8.png} % Change this to your image file
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.9\textwidth]{assets/use-case-2/k8-lb.png} % Change this to your image file
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.9\textwidth]{assets/use-case-2/docker-evaluation.png} % Change this to your image file
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.9\textwidth]{assets/use-case-2/evaluation-of-k8-and-k8-with-lb.png} % Change this to your image file
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{assets/use-case-2/block-explorer-dashboard.png} % Change this to your image file
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{assets/use-case-2/block-explorer-network.png} % Change this to your image file
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{assets/use-case-2/block-explorer-blocks.png} % Change this to your image file
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{assets/use-case-2/block-explorer-transactions.png} % Change this to your image file
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{assets/use-case-2/block-explorer-chaincode.png} % Change this to your image file
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{assets/use-case-2/block-explorer-channels.png} % Change this to your image file
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{assets/use-case-2/general-network-dashboard.png} % Change this to your image file
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{assets/use-case-2/general-network-resources.png} % Change this to your image file
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{assets/use-case-2/network-visualization.png} % Change this to your image file
    \caption{Second use case: admin web client general network resources}
    \label{fig:sample-image} 
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{assets/use-case-2/peer-config-upload-configs.png} % Change this to your image file
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{assets/use-case-2/peer-config-query-channels.png} % Change this to your image file
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{assets/use-case-2/peer-config-fetch-channel.png} % Change this to your image file
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{assets/use-case-2/peer-config-join-channel.png} % Change this to your image file
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{assets/use-case-2/peer-config-install-chaincode.png} % Change this to your image file
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{assets/use-case-2/peer-config-query-chaincode.png} % Change this to your image file
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{assets/use-case-2/peer-config-approve-chaincode.png} % Change this to your image file
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{assets/use-case-2/peer-config-query-chaincode-approvals.png} % Change this to your image file
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{assets/use-case-2/peer-config-commit-chaincode.png} % Change this to your image file
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{assets/use-case-2/peer-config-invoke-chaincode.png} % Change this to your image file
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{assets/use-case-2/peer-config-custom-commands.png} % Change this to your image file
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{assets/use-case-2/orderer-config-creating-channel.png} % Change this to your image file
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{assets/use-case-2/orderer-config-join-channel.png} % Change this to your image file
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{assets/use-case-2/orderer-config-query-channels.png} % Change this to your image file
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{assets/use-case-2/orderer-config-custom-commands.png} % Change this to your image file
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{assets/use-case-2/final-arch.png} % Change this to your image file
...
\paragraph{24º Phase: Article Review}\mbox{}\\
