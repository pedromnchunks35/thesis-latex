...
If putted into deep thinking, in the sphere of the modern new world, blockchain technology has loomed as an
auspicious solution to the given number of challenges faced by the healthcare industry.
Its enormous traits can range from cryptographic security, transparency and immutability and, by retaining such characteristics,
...
certain that only conceded parties have privileges to specific and confidential pieces of information. \cite{hyperledger-hippa-and-gdpr}
...
This investigation and the whole project, emerges from the notable rising recognition of the potential regarding the usage of blockchain
and other already established technologies. 
...
Nevertheless, early trials and implementations have been showing promising results in improvements regarding data security,
...
In this manner, the following research questions arise, which this study seeks to answer:
\begin{enumerate}
...
Addressing these questions will contribute to the understanding of the play role that a blockchain network can have
in the healthcare data management systems transformation.
...
\textbf{State of the Art}: Within this chapter there is the supply of the most important theoretical concepts that
...
specific to its sphere, such as implementations, solution comparison, approach, and final architecture.
