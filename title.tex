...
\begin{center}
    ...
    \vfill
\end{center}
   % Position the date at the bottom of the page
    \vspace{0.5cm} % Fine-tune this spacing as needed
    \hspace{4.2cm} % Adjust horizontal position relative to the column
